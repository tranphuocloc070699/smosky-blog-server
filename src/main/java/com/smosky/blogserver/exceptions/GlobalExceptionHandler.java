...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ResponseDto> handleGlobalException(Exception exception,
    ...
    ResponseDto responseDto = ResponseDto.builder()
        ...
        .message(PostsConstant.MESSAGE_FAIL)
  ...
  @ExceptionHandler(PostsAlreadyExistException.class)
  public ResponseEntity<ResponseDto> handleCustomerAlreadyExistsException(PostsAlreadyExistException exception,
                                                                               WebRequest webRequest){
    ResponseDto responseDto = ResponseDto.builder()
        .path(webRequest.getContextPath())
        .timestamp(new Date())
